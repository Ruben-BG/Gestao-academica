...
public class CadastroEdicaoDeProfessor extends javax.swing.JFrame {
    ...
    public CadastroEdicaoDeProfessor(JTablePersonalizada tabela) {
    ...
    public void mudarFuncaoDaJanela(Boolean isTelaDeCadastro, JTablePersonalizada tabela) {
        ...
        if (isTelaDeCadastro.equals(true)) {
            ...
            professor = BancoDeDados.retornarProfessores().get(tabela.getSelectedRow());
            ...
            senhaPasswordField.setText(professor.getSenha());
    ...
    private void pegaDadosProfessor(UsuarioProfessor novoProfessor) {
    ...
    private void acaoDoBotaoSalvar(JTablePersonalizada tabela) {
        ...
        if (telaDeCadastro && !gerarPopUp()) {
            ...
            p = new PopUp();
            p.mensagemFinalDoCadastroDaLista("Conta criada com sucesso!", this);
            limpaCampos();
            ...
            professor = new UsuarioProfessor();
            pegaDadosProfessor(professor);
            BancoDeDados.editarProfessor(tabela.getSelectedRow(), professor);
            
            p = new PopUp();
            p.mensagemFinalDoCadastroDaLista("Edição finalizada com sucesso!", this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroEdicaoDeProfessor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroEdicaoDeProfessor(null).setVisible(true);
            }
        });
    }
